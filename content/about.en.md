...
and a technical debt.

## Experience

**Senior backend engineer (Python, Go)** – Avito, Remote (March 2024 – present)
> I develop antifraud microservices

`Scrum` `Python` `Go` `PostgreSQL` `MongoDB` `Redis` `Kafka` `Pulsar` `Kubernetes`

**Backend team lead** – ITASystems (1cupis project), Moscow (February 2023 – March 2024)
> I lead a team of 8 people: devs, QA & system analyst.

> - assessment of employees performance & providing feedbacks
...
**Backend engineer** – ITASystems (1cupis project), Moscow (June 2021 – January 2023)
> I developed an antifraud for a payment system. In general, I did optimizations - looked for
> bottlenecks and increased service performance.
...
**Fullstack engineer** – Printum, Moscow (December 2020 – June 2021)
...
**Test automation engineer** – Tensor, Novosibirsk (December 2019 – November 2020)
...
**Entrepreneur** – E-commerce, Novosibirsk (June 2018 – December 2019)
...
> My passion for [optimization](https://github.com/KazakovDenis/JointPrice) with Python led me
> eventually to IT.

`Python` `Liquid` `InSales` `Yandex Direct`

**Company commander, senior engineer** – The Armed Forces of the Russian Federation, Novosibirsk
(July 2012 – June 2018)
...
**Higher, specialist degree** – The Land Forces academy of the Armed Forces of the Russian Federation, Omsk (2007 – 2012)
Engineer, automobiles and their maintenance

**Additional to higher** – The Land Forces academy of the Armed Forces of the Russian Federation, Omsk (2010 – 2012)
